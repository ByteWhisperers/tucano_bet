...
$stmt = $pdo->prepare("SELECT id, game_name, game_img, game_code FROM bet_jogos WHERE game_ativado = 1 AND game_destacado = 1 AND game_code != 'sport' ORDER BY RAND() LIMIT 6");
$stmt->execute();
